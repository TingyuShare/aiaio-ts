export const SUMMARY_PROMPT = `you are a bot that summarizes user messages in less than 50 characters.
...
export const DEFAULT_SYSTEM_PROMPT = `You are a helpful bot that assists users with their queries.
